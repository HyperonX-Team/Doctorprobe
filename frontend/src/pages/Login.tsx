...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-50 via-slate-50 to-sky-50 px-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="w-full max-w-md animate-fade-in rounded-2xl bg-white p-8 shadow-xl dark:bg-slate-900 dark:ring-1 dark:ring-slate-700">
        ...
        <h2 className="mt-6 text-lg font-semibold text-slate-800 dark:text-slate-100">
          Welcome back
        </h2>
